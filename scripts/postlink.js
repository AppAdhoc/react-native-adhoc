...
// console.log("react-native-adhoc postlink start");
...
function addFrameworkAndSearchPath() {
  ...
  /*
  console.log(
    "react-native-adhoc postlink addFrameworkAndSearchPath projectPath:" +
      projectPath
  );
  */
  ...
  var frameworkPath = path.join(
    __dirname,
    "../node_modules/react-native-adhoc/ios/RNAdhoc/AdhocSDK.framework"
  );
...
function addSearchPaths(project, frameworkSearchPath) {
  ...
  Object.keys(config)
    ...
    /*
      console.log(
        "react-native-adhoc postlink addSearchPaths buildSettings[PRODUCT_NAME]:" +
